...
const DashboardOng = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    const updatedFormData = { ...formData, contactPersonId: userData?.collaboratorId };
          ...
          {modalOpen && (
            <div className="modal-background" onClick={handleBackgroundClick}>
              <div className="modal relative">
                ...
                <div className='flex flex-col gap-[12px] w-[400px]'>
                  ...
                  <div className="grid grid-cols-1 gap-[24px] items-center">
                    ...
                    <InputCustom
                      label="Link do Curso"
                      placeholder="Coloque o link de acesso ao curso"
                      id="link"
                      name="link"
                      value={formData.link}
                      onChange={handleInputChange}
                    ...
                    <button type="submit" className="save cursor-pointer hover:opacity-85" onClick={handleFormSubmit}>
